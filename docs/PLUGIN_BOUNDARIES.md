...
> **Источники:** [ARCHITECTURE.md](ARCHITECTURE.md) §6 (паттерн Ядро–Тема–Плагин, инварианты 13–14), [PLUGIN_TRANSITION.md](PLUGIN_TRANSITION.md) (фазы 0–7), [readme.md](SDS.md) §6.0/§6.8 (продуктовый приоритет и Far/TC мосты), [UI_PRIMITIVES.md](UI_PRIMITIVES.md) и связанные `*_PLUGIN.md`.
